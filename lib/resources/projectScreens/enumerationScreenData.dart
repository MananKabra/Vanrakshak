                        ...
                        onPressed: () async {
                          ...
                          if (snapshot["title"] == 'validation') {
                            url =
                                ...
                                "http://10.0.2.2:5000/treeEnumerationn?ProjectID=$projectID&imageLink=${snapshot["map"]["satelliteImageWithNoPolygon"]}";
                            ...
                            url =
                                "http://10.0.2.2:5000/treeEnumerationd?ProjectID=$projectID&imageLink=${snapshot["map"]["satelliteImageWithNoPolygon"]}";
